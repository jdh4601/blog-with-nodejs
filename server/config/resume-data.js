const resumeData = {
  ...
  Interests: 'Computer Vision, Vision Transformer (ViT), Software Engineering',
  experiences: [
    {
      title: 'Undergraduate Researcher (Computer Vision Lab)',
      company: 'Incheon National University',
      startDate: 'Feb 2025',
      endDate: 'Present',
      responsibilities: [
        'Engaged in research on advanced object detection techniques using event-based camera systems.',
      ],
    },
    {
